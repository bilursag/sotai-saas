...
export function GridBackgroundDemo({ children }: { children?: React.ReactNode }) {
  return (
    <div className="min-h-screen w-full dark:bg-black bg-white  dark:bg-grid-white/[0.04] bg-grid-black/[0.08] relative flex items-center justify-center">
